...
module.exports = async({ getNamedAccounts, deployments, getChainId }) => {
    ...
    const traderWalletAddress = "0x096f6A2b185d63D942750A2D961f7762401cbA17"; // TESTING ONLY!!!
    ...
    while (ethers.BigNumber.from(baseToken.address).gt(ethers.BigNumber.from(quoteToken.address))) {
